...
export default class extends SmartPage {
  render = () => {
    ...
    return (
      <div>
        <Head
          title="Chogasova choroba - Nevšímejte si nás! Kala Azar a spol. - Lékaři bez hranic"
          ...
          ogTitle="Chogasova choroba - Nevšímejte si nás! Kala Azar a spol. - Lékaři bez hranic"
